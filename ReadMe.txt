...
1-> Starting the server
        ...
        -server it should be in the begining 

        -d /home/student/files is for a full directry and it should not contain spaces or you will have and error reading that directry

        -p 2500 this port number should be an interger and should start above 1023
